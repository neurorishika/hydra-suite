...
- Identity decoder: `core/individual/identity/online.py:148+` (sticky transition `203-208`, fuse `333-351`, swap `667-729`, slot-lock `653-659`, uniqueness Hungarian `515-551`, commit `590-597`).
...
- Rich-export + fragment solver: `gui/orchestrators/tracking.py:3111-3175`
  → `core/individual/identity/offline.py:run_fragment_solver` (line 1335);
