...
from hydra_suite.core.tracking.detection_phase import _read_nvdec_batch, _try_open_nvdec
...
def test_try_open_nvdec_succeeds_and_primes_first_frame(monkeypatch):
    ...
    monkeypatch.setattr(
        "hydra_suite.core.tracking.detection_phase._nvdec_frame_to_cuda_tensor",
