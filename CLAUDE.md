...
- **New classifier artifact**: must carry `fit_policy` (`letterbox`/`squash`/`native`); preprocess only via `core.canonicalization.fit.fit_crops_for_policy`. See `docs/developer-guide/classifier-compatibility.md`
