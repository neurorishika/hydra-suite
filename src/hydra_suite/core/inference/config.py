...
class SliceConfig:
    ...
    # Positive explicit requested maximum, always clamped by the tile memory
    # budget below. A coordinated calibration profile may supply this value;
    # otherwise it is exactly what the user asked for.
