...
class ConfigOrchestrator:
    ...
    def get_parameters_dict(self: object) -> object:
        ...
        advanced_config["canonical_margin"] = (
            self._panels.detection.spin_canonical_margin.value()
        )
    ...
    def _load_advanced_config(self):
        ...
        # Shared with the CLI loader (trackerkit/cli_config.py) via
        # advanced_defaults.DEFAULT_ADVANCED_CONFIG -- see that module for the
        # full key accounting.
        default_config = default_advanced_config()
