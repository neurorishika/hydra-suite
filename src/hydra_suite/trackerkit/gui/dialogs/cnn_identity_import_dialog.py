...
def annotate_discovered_cnn_entry(
    *,
    rel_path: str,
    species: str,
    ...
    """Write a TrackerKit-side annotation into the model registry.

    Used when a model appears in the combo via discovery (no registry entry
